/*
  ...
  - The values [technicien] on the enum `RoleName` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "RoleName_new" AS ENUM ('admin', 'superadmin', 'dev', 'user');
